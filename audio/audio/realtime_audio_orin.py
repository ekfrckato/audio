...
class RealtimeAudio(Node):
    def __init__(self):
        super().__init__('realtime_audio_orin')
        self.CHUNK = 1024
        ...
        self.publisher = self.create_publisher(UInt8MultiArray, '/voice_Orin', 10)
        self.subscription = self.create_subscription(UInt8MultiArray, '/voice_PC', self.sub_audio, 10)
        self.subscription
